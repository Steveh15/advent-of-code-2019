	...
	void computer(int input, std::vector<int> states) {
		...
		while (opcode != 99) {
			...
			if (opcode == 3) {
				...
				std::cout << states[states[i + 1]] << "\n";
				i += 2;
			}
			else if (opcode == 99) std::cout << "Halting";
			else{
