...
namespace Day9 {
	...
	void solution() {
		...
		std::cout << "Part 1 solution: " << comp1.getOuput() << "\n";

		Computer comp2(initial_state);
		while (!comp2.is_halted) {
			comp2.run(2);
		}
		std::cout << "Part 2 solution: " << comp2.getOuput() << "\n\n";
